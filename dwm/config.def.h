...
static const char *const autostart[] = {
	...
	//"feh", "--bg-max", "$HOME/wallpaper/first-collection/ubuntu-1.png", NULL,
	NULL /* terminate */
};
...
static const Key keys[] = {
	...
	{ MODKEY,                       XK_f,      spawn,          SHCMD ("flameshot full -p $HOME/Pictures/")},
	{ MODKEY|ShiftMask,             XK_f,      spawn,          SHCMD ("flameshot gui -p $HOME/Pictures/")},
	{ MODKEY|ControlMask,           XK_f,      spawn,          SHCMD ("flameshot gui --clipboard")},
